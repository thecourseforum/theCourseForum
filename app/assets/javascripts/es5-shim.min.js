...
(function ()
{
  ...
  Array.prototype.some || (Array.prototype.some = function (a, b)
  {
    ...
    if (h(a) != "[object Function]") throw new TypeError(a + " is not a function");
    for (var f = 0; f < e; f++)
      if (f in c && a.call(b, c[f], f, d)) return true;
    return false
  });
  ...
  {
    var b = l &&
      h(this) == "[object String]" ? this.split("") : n(this),
      d = b.length >>> 0;
    if (!d) return -1;
    var c = 0;
    arguments.length > 1 && (c = v(arguments[1]));
    for (c = c >= 0 ? c : Math.max(0, d + c); c < d; c++)
  ...
  if (!Array.prototype.lastIndexOf || -1 != [0, 1].lastIndexOf(0, -3)) Array.prototype.lastIndexOf = function (a)
  {
    ...
    for (c = c >= 0 ? c : d - Math.abs(c); c >= 0; c--)
      if (c in b &&
        a === b[c]) return c;
    return -1
  };
