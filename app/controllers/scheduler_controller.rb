class SchedulerController < ApplicationController
  ...
  def render_ical_event(section)
      ...
      section.day_times.sort_by{|s| [s.start_time, s.end_time, day_to_number(s.day)] }.each do |day_time|
        ...
        event_start = DateTime.new(2016, 8, eventDate, startingHour.to_i, startingMinutes.to_i, 1) #seconds have to be set otherwise it doesn't add
        event_end = DateTime.new(2016, 8, eventDate, endingHour.to_i, endingMinutes.to_i, 1)
        ...
        event.rrule = "FREQ=WEEKLY;UNTIL=20161206T000000Z" #repeats once a week until hardcoded course end date (could do COUNT= if num occurences is known)
