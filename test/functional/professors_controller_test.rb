...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { email_alias: @professor.email_alias, first_name: @professor.first_name, last_name: @professor.last_name, preferred_name: @professor.preferred_name }
    end
  ...
  test "should update professor" do
    put :update, id: @professor, professor: { email_alias: @professor.email_alias, first_name: @professor.first_name, last_name: @professor.last_name, preferred_name: @professor.preferred_name }
    assert_redirected_to professor_path(assigns(:professor))
  end
