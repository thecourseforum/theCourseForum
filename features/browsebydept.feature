Feature: Browse by department/all 
	...
	Scenario: subdepartments should be listed
		...
		Then I should see all subdepartments in East Asian Languages, Literatures & Cultures 
	...
	Scenario: professor is clicked from a list of professors
		...
		Then a "sort by" label should appear with a drop down menu
	...
	Scenario: subdepartments should be listed
		...
		Then I should see all subdepartments in Psychology 	
		And their classes should be listed below them
	...
	Scenario: professors who have taught the course should be listed
		...
		Then the number of reviews for each professor should be listed 
		Then the ratings for each professor should be listed  
